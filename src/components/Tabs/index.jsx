...
const Tabs = ({ children, current, setCurrent, vertical, small }) => {
  return (
    ...
    >
      <TabsContext.Provider value={{ current, setCurrent, vertical, small }}>
        {children}
  ...
  return (
    <button
      ...
      className={classnames(
        "block border border-gray-800 bg-gray-700 text-left text-white hover:bg-gray-600",
        {
          "border-r-0 first:ml-0 first:rounded-l-sm last:mr-0 last:rounded-r-sm last:border-r":
            !vertical,
          "border-b-0 first:mt-0 first:rounded-t-sm last:mb-0 last:rounded-b-sm last:border-b":
            vertical,
