    ...
    <>
      ...
      <div className="container-lg mt-20">
        <div className="row">
          <div className="col-full">
            <p className="typo-h4 mb-3">Please consider citing MultiQC if you use it in your analysis.</p>
            ...
            <div className="row">
              <div className="col-full md:col-6 lg:col-8 mb-8">
                ...
                <p className="typo-body ">Philip Ewels, Måns Magnusson, Sverker Lundin and Max Käller.</p>
      ...
      <div className="container-lg my-8">
        ...
        <p className="typo-body my-4">
          <span className="font-semibold">Motivation:</span> Fast and accurate quality control is essential for studies
          involving next-generation sequencing data. Whilst numerous tools exist to quantify QC metrics, there is no
          common approach to flexibly integrate these across tools and large sample sets. Assessing analysis results
          across an entire project can be time consuming and error prone; batch effects and outlier samples can easily
          be missed in the early stages of analysis.
        </p>
        <p className="typo-body my-4">
          <span className="font-semibold">Results:</span> We present MultiQC, a tool to create a single report
          visualising output from multiple tools across many samples, enabling global trends and biases to be quickly
          identified. MultiQC can plot data from many common bioinformatics tools and is built to allow easy extension
          and customization.
        </p>
        <p className="typo-body my-4">
          <span className="font-semibold">Availability:</span> MultiQC is available with an GNU GPLv3 license on GitHub,
          the Python Package Index and Bioconda. Documentation and example reports available at{" "}
        ...
        <p className="typo-small my-12 text-gray-600">
          ...
          , which permits unrestricted reuse, distribution, and reproduction in any medium, provided the original work
          is properly cited.
        </p>
      </div>
    </>
