        ...
        <div className="row">
          <div className="col-full md:col-10">
            <p className="typo-body mb-4">
              MultiQC is built in such a way that externally managed Python packages can tie in to its functionality.
              This allows separate plugin tools to extend its capabilities, adding new modules, report templates and
              doing useful things with the parsed data.
            </p>
            <p className="typo-body">
              The below list highlights a few such plugins - some may be useful to you if they interact with external
              tools which you use (eg. <span className="font-medium">MultiQC_Clarity</span>
      ...
      <div className="container-lg mt-20 md:mt-0 md:py-20">
        <div className="row">
          ...
          <div className="col-full md:col-6 md:ml-1/12">
            <h2 className="typo-h3 mb-4 mt-10 md:mt-0">MultiQC_Clarity</h2>
            ...
            <p className="typo-body mb-4">
              MultiQC_Clarity connects to your Clarity LIMS installation using the API. MultiQC runs as normal,
              generating a list of sample names based on the contents of the files found. These sample names are passed
              to the MultiQC_Clarity plugin, which searches your Clarity LIMS installation for matching sample names. If
              exact matches are found, then the metadata configured in the config file is retrieved and entered into the
              report.
            </p>
            <div className="mt-4 md:mt-8">
