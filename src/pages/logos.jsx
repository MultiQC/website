  ...
  return (
    <>
      ...
      <div className="container-lg py-20">
        <h2 className="typo-h3 mb-4">Introduction</h2>
        ...
        <h3 className="typo-h4 mt-8 mb-4">Design Details</h3>
        <p className="typo-body mb-4">
          <strong>Font:</strong>{" "}
          <span>
        ...
        <p className="typo-body mb-4">
          <strong>Text Colour:</strong> <span>#000000</span>
        </p>
        <p className="typo-body mb-4">
          <strong>Colour 1:</strong> <span>#BE1622</span>
        </p>
        <p className="typo-body mb-4">
          <strong>Colour 2:</strong> <span>#009640</span>
        </p>
        <p className="typo-body mb-4">
          <strong>Colour 3:</strong> <span>#1D71B8</span>
        </p>
        <h3 className="typo-h4 mt-8 mb-4">MultiQC Logo</h3>
        ...
        <List iconClassName="text-blue-600">
          <List.Item className="typo-body text-blue-600">
            <Link to="/logos/multiqc_logo.png">PNG</Link>
          </List.Item>
          <List.Item className="typo-body text-blue-600">
            <Link to="/logos/multiqc_logo.svg">SVG</Link>
          </List.Item>
          <List.Item className="typo-body text-blue-600">
            <Link to="/logos/multiqc_logo.ai">Illustrator CS5</Link>
          </List.Item>
        </List>
        <h3 className="typo-h4 mt-8 mb-4">MultiQC Logo (dark background)</h3>
        <div className="row mb-4">
          <div className="col-full sm:col-6">
        ...
        <List iconClassName="text-blue-600">
          <List.Item className="typo-body text-blue-600">
            <Link to="/logos/multiqc_logo_darkbg.png">PNG</Link>
          </List.Item>
          <List.Item className="typo-body text-blue-600">
            <Link to="/logos/multiqc_logo_darkbg.svg">SVG</Link>
          </List.Item>
          <List.Item className="typo-body text-blue-600">
            <Link to="/logos/multiqc_logo_darkbg.ai">Illustrator CS5</Link>
          </List.Item>
        </List>
        <h3 className="typo-h4 mt-8 mb-4">MultiQC Square Thumb</h3>
        <div className="row mb-4">
        ...
        <List iconClassName="text-blue-600">
          <List.Item className="typo-body text-blue-600">
            <Link to="/logos/multiqc_logo_square.png">PNG</Link>
          </List.Item>
          <List.Item className="typo-body text-blue-600">
            <Link to="/logos/multiqc_logo_square.svg">SVG</Link>
          </List.Item>
          <List.Item className="typo-body text-blue-600">
            <Link to="/logos/multiqc_logo_square.ai">Illustrator CS5</Link>
          </List.Item>
        </List>
        <h3 className="typo-h4 mt-8 mb-4">MultiQC Circle Thumb</h3>
        <div className="row mb-4">
          <div className="col-6 sm:col-3">
            <div className="bg-gray-200 p-10">
        ...
        <List iconClassName="text-blue-600">
          <List.Item className="typo-body text-blue-600">
            <Link to="/logos/multiqc_logo_circle.png">PNG</Link>
          </List.Item>
          <List.Item className="typo-body text-blue-600">
            <Link to="/logos/multiqc_logo_circle.svg">SVG</Link>
          </List.Item>
          <List.Item className="typo-body text-blue-600">
            <Link to="/logos/multiqc_logo_circle.ai">Illustrator CS5</Link>
          </List.Item>
        </List>
      </div>
    </>
